...
```{r figure21, echo=FALSE, message=FALSE, fig.cap="Figure 21 (fig. S2): Heatmap displaying the relative performance of 183 strains grown in liquid media. Column A and B show the mean LSC or LPI (n=6) of these strains, based on the solid media Scan-o-matic experiments, and columns C-H the mean LPI (n=3) of the strains based on growth in liquid media", fig.width=5, fig.height=40}
library(pheatmap)
