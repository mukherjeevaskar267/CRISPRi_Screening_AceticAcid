...
```{r figure5, echo=FALSE, fig.cap="Figure 5: Boxplot of relative generation time (LPI GT) for all strains including all replicates in the library", fig.width=2, fig.height=4}
...
```{r figure6, echo=FALSE, fig.cap="Figure 6 (Fig S9 in Manuscript): P-value diagnostic by histogram, Method 3", fig.width=8, fig.height=8}
par(mfrow=c(2,2))
...
```{r figure7, echo=FALSE, fig.cap="Figure 7: P-value diagnostic by histogram, Method 4", fig.width=8, fig.height=8}
par(mfrow=c(2,2))
...
```{r figure8, echo=FALSE, fig.cap="Figure 8 (Fig. 2A in Manuscript): DATA REPRODUCIBILITY", fig.width=8, fig.height=8}
...
````{r figure9, echo=FALSE, fig.cap="Figure 9 (Fig. 2C in Manuscript): Normalized generation time (LSC GT) of strains in Basal condition vs Relative generation time (LPI GT) of strains in acetic acid condition compared to basal condition", fig.width=8, fig.height=8}
...
```{r figure10, echo=FALSE, fig.cap="Figure 10 (Fig. 2C INSET, in Manuscript): Violin-plots display the spread and the distribution of the LPI GT data", fig.width=5, fig.height=7}
library(ggplot2)
...
```{r figure11, echo=FALSE, fig.cap="Figure 11: Wordcloud for CRISPRi gene targets of acetic acid tolerant strains", fig.width=10, fig.height=10}
library("wordcloud")
...
```{r figure12, echo=FALSE, fig.cap="Figure 12: Wordcloud for CRISPRi gene targets of acetic acid sensitive strains", fig.width=10, fig.height=10}
library("wordcloud")
...
```{r figure13, echo=FALSE, fig.cap="Figure 13: Histogram of number of strains per target gene in the CRISPRi library (TOP PANEL). Histogram of gRNA distance from Transcription starting site of the Genes (BOTTOM PANEL)", fig.width=4, fig.height=8}
par(mfrow=c(2,1))
hist(gRNA_Freq$Freq,
     breaks = 20,
     xlim = c(0, 20),
...
```{r figure14, echo=FALSE, fig.cap="Figure 14 (fig. 2B in manuscript): Histogram to display strains growth in Basal condition (TOP PANEL). Histogram to display strains growth at 150mM of acetic acid (BOTTOM PANEL)", fig.width=5, fig.height=10}
par(mfrow=c(2,1))
...
```{r figure15, echo=FALSE, message=FALSE, fig.cap="Figure 15 (fig. S1B in manuscript): Scatter plot to display ATC dosage response on Lag phase", fig.width=6, fig.height=4}
library(ggplot2)
...
```{r figure16, echo=FALSE, fig.cap="Figure 16 (fig. S1B in manuscript): Scatter plot to display ATC dosage response on Generation time", fig.width=6, fig.height=4}
...
```{r figure17, echo=FALSE, message=FALSE, fig.cap="Figure 17 (fig. S1B in manuscript): Scatter plot to display ATC dosage response on Yield", fig.width=6, fig.height=4}
