...
* Number of gRNA each target Gene in the CRISPRi library

For this graph we fetch some additional information from a .CSV file available as supplementary in smith et al., 2017. The file is also available in our COMPILED_DATA folder
