...
```{r fig1, echo=FALSE, fig.cap="Figure 1: Boxplot of mean relative generation time (LPI GT)", fig.width=2, fig.height=4}
...
```{r fig2, echo=FALSE, fig.cap="Figure 2: P-value diagnostics", fig.width=8, fig.height=8}
par(mfrow=c(2,2))
