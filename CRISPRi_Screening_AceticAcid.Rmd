...
```{r figure6, echo=FALSE, fig.cap="Figure 6: P-value diagnostic by histogram, Method 3", fig.width=8, fig.height=8}
par(mfrow=c(2,2))
...
### CORRELATION SCATTER PLOT BETWEEN LPI GT MEAN ROUND 1 and LPI GT MEAN ROUND 2
...
plot(Analysis_Final_3$LPI_GT_RND1_MEAN, Analysis_Final_3$LPI_GT_RND2_MEAN, 
     ...
     cex = 0.5, 
     col = "black", 
     main = "LPI_GT_Round1_Mean vs LPI GT_Round2_Mean", 
     xlab = "LPI_GT_Round1_Mean", 
     ylab = "LPI_GT_Round2_Mean", 
     xlim = c(-0.5, 2), 
     ylim = c(-0.5, 2),
     cex.lab=1.3,
     cex.axis=1.3)
...
The linear regression fitting model (**black line**) for the data of all strains together gave a co-efficient of determination i.e. **R^2^ = 0.22** and Pearson correlation coefficient **r = 0.47** 
...
plot(Analysis_Final_3$CTRL_GT_Mean_all, Analysis_Final_3$LPI_GT_Mean_all, 
     ...
     cex = 0.5, 
     col = "black", 
     main = "Overview of CRISPRi strain performance", 
     xlab = "LSC_GT Basal.condition", 
     ylab = "LPI_GT Acetic acid 150mM", 
     xlim = c(-0.5, 2), 
     ylim = c(-0.5, 2),
     yaxt="n",
     xaxt="n",
